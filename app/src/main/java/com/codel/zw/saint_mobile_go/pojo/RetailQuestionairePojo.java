...
public class RetailQuestionairePojo {
    ...
    public RetailQuestionairePojo(String did_you_like_product, String product_you_liked, String have_you_used_product) {
    ...
    public RetailQuestionairePojo(String did_you_like_product, String product_you_liked) {
        this.did_you_like_product = did_you_like_product;
        this.product_you_liked = product_you_liked;
    }
