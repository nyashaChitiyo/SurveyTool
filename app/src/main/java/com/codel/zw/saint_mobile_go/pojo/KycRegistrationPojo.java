...
public class KycRegistrationPojo {
    String firstname;
    String lastname;
    String dob;
    ...
    public String getFhobies() {
        return fhobies;
    }

    public void setFhobies(String fhobies) {
        this.fhobies = fhobies;
    }

    public String getFvisitedmalls() {
        return fvisitedmalls;
    }

    public void setFvisitedmalls(String fvisitedmalls) {
        this.fvisitedmalls = fvisitedmalls;
    }
    ...
    public String getFoodgrocery() {
        return foodgrocery;
    }

    public void setFoodgrocery(String foodgrocery) {
        this.foodgrocery = foodgrocery;
    }
